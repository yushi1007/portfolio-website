...
const About = () => {
    ...
    <div id="about" class="section section-summary js--section-summary">
        <div className="row">
        <Slide left duration={800}><h1>About Me</h1></Slide>
        <Fade bottom duration={1000} delay={150}>
            <p className="summary">
                <strong>Hi there! my name is Yu Shi, a Software Engineer with experience building full stack applications with JavaScript, React, and Ruby on Rails.</strong>
                <br/>Possess strong skills in designing, developing and testing multiple web-based applications. Data driven and creative in finding solutions to complex problems. Love to develop innovative applications that enable creativity.
            </p>
        </Fade>
